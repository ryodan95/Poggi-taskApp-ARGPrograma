...
const ModalAgregarTarea: React.FC<ModalAgregarTareaProps> = ({showModal, handleClose, createTask}) => {
    const validationSchema = Yup.object ({
        ...
        tiempo: Yup.number().required('Este campo es requerido').integer('El tiempo debe ser en numeros').positive('El tiempo debe mayor a 0'),
        ...
        <Modal.Body>
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className="mb-3 mt-1">
                    ...
                    <input type="text" className="form-control" id="titulo" name="titulo" onChange={formik.handleChange}
                    onBlur={formik.handleBlur} value={formik.values.titulo} />
                  ...
                  <div className="mb-3 mt-1">
                    ...
                    <textarea className="form-control" id="descripcion" name="descripcion" onChange={formik.handleChange}
                    onBlur={formik.handleBlur} value={formik.values.descripcion} 
                  ...
                  <div className="mb-3 mt-1">
                    ...
                    <input placeholder='Ej: 30 días' type="number" className="form-control" id="tiempo" name="tiempo" onChange={formik.handleChange}
                    onBlur={formik.handleBlur} value={formik.values.tiempo} />
                  ...
                  <div className="mb-3 mt-1">
                    ...
                    <input type="text" className="form-control" id="imagen" name="imagen" onChange={formik.handleChange}
                    onBlur={formik.handleBlur} value={formik.values.imagen} />
                  ...
                  <div className="mb-3 mt-1">
                    ...
                    <input type="text" className="form-control" id="responsable" name="responsable" onChange={formik.handleChange}
                    onBlur={formik.handleBlur} value={formik.values.responsable} />
                ...
                <div className="mb-3 mt-1">
                    ...
                    <Form.Select id="estado" name="estado" onChange={formik.handleChange}
                    onBlur={formik.handleBlur} value={formik.values.estado}>
